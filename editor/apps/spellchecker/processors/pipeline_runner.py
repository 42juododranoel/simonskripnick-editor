...
from editor.apps.spellchecker.processors.extractors.tree_extractor import TreeExtractor
from editor.apps.spellchecker.processors.loaders.document_loader import DocumentLoader
from editor.apps.spellchecker.processors.transformers.tree_transformer import (
    TreeTransformer,
)
